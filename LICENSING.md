...
A `LICENSE-omnigent` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [omnigent-ai/omnigent](https://github.com/omnigent-ai/omnigent), Copyright
the omnigent-ai/omnigent authors, licensed under Apache-2.0. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../omnigent-port/specs/SPEC-001-omnigent.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
